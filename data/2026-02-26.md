...
### [16] [ACAR: Adaptive Complexity Routing for Multi-Model Ensembles with Auditable Decision Traces](https://arxiv.org/abs/2602.21231)
*Ramchand Kumaresan*
...
### [17] [Urban Vibrancy Embedding and Application on Traffic Prediction](https://arxiv.org/abs/2602.21232)
...
### [18] [AngelSlim: A more accessible, comprehensive, and efficient toolkit for large model compression](https://arxiv.org/abs/2602.21233)
...
### [19] [Group Orthogonalized Policy Optimization:Group Policy Optimization as Orthogonal Projection in Hilbert Space](https://arxiv.org/abs/2602.21269)
*Wang Zixian*
...
### [20] [Neural network optimization strategies and the topography of the loss landscape](https://arxiv.org/abs/2602.21276)
...
### [21] [SymTorch: A Framework for Symbolic Distillation of Deep Neural Networks](https://arxiv.org/abs/2602.21307)
...
### [26] [Efficient Opportunistic Approachability](https://arxiv.org/abs/2602.21328)
...
### [27] [Archetypal Graph Generative Models: Explainable and Identifiable Communities via Anchor-Dominant Convex Hulls](https://arxiv.org/abs/2602.21342)
...
### [28] [Provably Safe Generative Sampling with Constricting Barrier Functions](https://arxiv.org/abs/2602.21429)
...
### [29] [Neural solver for Wasserstein Geodesics and optimal transport dynamics](https://arxiv.org/abs/2602.22003)
...
### [30] [The Mean is the Mirage: Entropy-Adaptive Model Merging under Heterogeneous Domain Shifts in Medical Imaging](https://arxiv.org/abs/2602.21372)
...
### [31] [VCDF: A Validated Consensus-Driven Framework for Time Series Causal Discovery](https://arxiv.org/abs/2602.21381)
...
### [32] [FedVG: Gradient-Guided Aggregation for Enhanced Federated Learning](https://arxiv.org/abs/2602.21399)
...
### [33] [Defensive Generation](https://arxiv.org/abs/2602.21390)
...
### [34] [Overconfident Errors Need Stronger Correction: Asymmetric Confidence Penalties for Reinforcement Learning](https://arxiv.org/abs/2602.21420)
...
### [35] [On the Structural Non-Preservation of Epistemic Behaviour under Policy Transformation](https://arxiv.org/abs/2602.21424)
*Alexander Galozy*
...
### [36] [Generative Bayesian Computation as a Scalable Alternative to Gaussian Process Surrogates](https://arxiv.org/abs/2602.21408)
...
### [37] [Benchmarking State Space Models, Transformers, and Recurrent Networks for US Grid Forecasting](https://arxiv.org/abs/2602.21415)
...
### [38] [Causal Decoding for Hallucination-Resistant Multimodal Large Language Models](https://arxiv.org/abs/2602.21441)
...
### [39] [MINAR: Mechanistic Interpretability for Neural Algorithmic Reasoning](https://arxiv.org/abs/2602.21442)
...
### [40] [GradAlign: Gradient-Aligned Data Selection for LLM Reinforcement Learning](https://arxiv.org/abs/2602.21492)
...
### [41] [Proximal-IMH: Proximal Posterior Proposals for Independent Metropolis-Hastings with Approximate Operators](https://arxiv.org/abs/2602.21426)
...
### [43] [From Basis to Basis: Gaussian Particle Representation for Interpretable PDE Operators](https://arxiv.org/abs/2602.21551)
...
### [44] [Learning from Yesterday's Error: An Efficient Online Learning Method for Traffic Demand Prediction](https://arxiv.org/abs/2602.21757)
...
### [45] [Generalisation of RLHF under Reward Shift and Clipped KL Regularisation](https://arxiv.org/abs/2602.21765)
...
### [46] [When Learning Hurts: Fixed-Pole RNN for Real-Time Online Training](https://arxiv.org/abs/2602.21454)
...
### [47] [Excitation: Momentum For Experts](https://arxiv.org/abs/2602.21798)
*Sagi Shaier*
...
### [48] [Effects of Training Data Quality on Classifier Performance](https://arxiv.org/abs/2602.21462)
...
### [49] [xai-cola: A Python library for sparsifying counterfactual explanations](https://arxiv.org/abs/2602.21845)
*Lin Zhu,Lei You*
...
### [50] [Asymptotically Fast Clebsch-Gordan Tensor Products with Vector Spherical Harmonics](https://arxiv.org/abs/2602.21466)
...
### [51] [Physics-Informed Machine Learning for Vessel Shaft Power and Fuel Consumption Prediction: Interpretable KAN-based Approach](https://arxiv.org/abs/2602.22055)
...
### [52] [Geometric Priors for Generalizable World Models via Vector Symbolic Architecture](https://arxiv.org/abs/2602.21467)
...
### [53] [DualWeaver: Synergistic Feature Weaving Surrogates for Multivariate Forecasting with Univariate Time Series Foundation Models](https://arxiv.org/abs/2602.22066)
...
### [54] [D-Flow SGLD: Source-Space Posterior Sampling for Scientific Inverse Problems with Flow Matching](https://arxiv.org/abs/2602.21469)
...
### [55] [On Imbalanced Regression with Hoeffding Trees](https://arxiv.org/abs/2602.22101)
...
### [56] [The Design Space of Tri-Modal Masked Diffusion Models](https://arxiv.org/abs/2602.21472)
...
### [57] [Don't stop me now: Rethinking Validation Criteria for Model Parameter Selection](https://arxiv.org/abs/2602.22107)
...
### [58] [Learning Recursive Multi-Scale Representations for Irregular Multivariate Time Series Forecasting](https://arxiv.org/abs/2602.21498)
...
### [59] [WaterVIB: Learning Minimal Sufficient Watermark Representations via Variational Information Bottleneck](https://arxiv.org/abs/2602.21508)
...
### [60] [GUI-Libra: Training Native GUI Agents to Reason and Act with Action-aware Supervision and Partially Verifiable RL](https://arxiv.org/abs/2602.22190)
...
### [61] [Muon+: Towards Better Muon via One Additional Normalization Step](https://arxiv.org/abs/2602.21545)
...
### [62] [Extending Sequence Length is Not All You Need: Effective Integration of Multimodal Signals for Gene Expression Prediction](https://arxiv.org/abs/2602.21550)
...
### [63] [Training-free Composition of Pre-trained GFlowNets for Multi-Objective Generation](https://arxiv.org/abs/2602.21565)
...
### [64] [Duel-Evolve: Reward-Free Test-Time Scaling via LLM Self-Preferences](https://arxiv.org/abs/2602.21585)
...
### [65] [ABM-UDE: Developing Surrogates for Epidemic Agent-Based Models via Scientific Machine Learning](https://arxiv.org/abs/2602.21588)
...
### [66] [Breaking Semantic-Aware Watermarks via LLM-Guided Coherence-Preserving Semantic Injection](https://arxiv.org/abs/2602.21593)
...
### [67] [NGDB-Zoo: Towards Efficient and Scalable Neural Graph Databases Training](https://arxiv.org/abs/2602.21597)
...
### [68] [Deep Clustering based Boundary-Decoder Net for Inter and Intra Layer Stress Prediction of Heterogeneous Integrated IC Chip](https://arxiv.org/abs/2602.21601)
...
### [69] [AgentLTV: An Agent-Based Unified Search-and-Evolution Framework for Automated Lifetime Value Prediction](https://arxiv.org/abs/2602.21634)
...
### [70] [Multimodal Survival Modeling and Fairness-Aware Clinical Machine Learning for 5-Year Breast Cancer Risk Prediction](https://arxiv.org/abs/2602.21648)
*Toktam Khatibi*
...
### [72] [Learning Complex Physical Regimes via Coverage-oriented Uncertainty Quantification: An application to the Critical Heat Flux](https://arxiv.org/abs/2602.21701)
...
### [73] [The Error of Deep Operator Networks Is the Sum of Its Parts: Branch-Trunk and Mode Error Decompositions](https://arxiv.org/abs/2602.21910)
...
### [74] [Learning Unknown Interdependencies for Decentralized Root Cause Analysis in Nonlinear Dynamical Systems](https://arxiv.org/abs/2602.21928)
...
### [75] [Bayesian Generative Adversarial Networks via Gaussian Approximation for Tabular Data Synthesis](https://arxiv.org/abs/2602.21948)
...
### [76] [Robustness in sparse artificial neural networks trained with adaptive topology](https://arxiv.org/abs/2602.21961)
...
### [77] [Compact Circulant Layers with Spectral Priors](https://arxiv.org/abs/2602.21965)
...
### [78] [Function-Space Empirical Bayes Regularisation with Student's t Priors](https://arxiv.org/abs/2602.22015)
...
### [79] [Disease Progression and Subtype Modeling for Combined Discrete and Continuous Input Data](https://arxiv.org/abs/2602.22018)
...
### [85] [Optimal extraction with an impact on diffusion-jump pricing](https://arxiv.org/abs/2602.21274)
...
### [86] [An accelerated rearrangement method for two-phase composite optimization](https://arxiv.org/abs/2602.21352)
...
### [87] [Fenchel-Young Estimators of Perturbed Utility Models](https://arxiv.org/abs/2602.21376)
...
### [88] [Narrowing the Gap: SOS Ranks of $4 \times 3$ Biquadratic Forms and a Lower Bound of $8$](https://arxiv.org/abs/2602.21570)
...
### [89] [Sum-Rate Maximization via Convex Optimization Using Subgradient Projections Onto Nonlinear Spectral Radius Constraint Sets](https://arxiv.org/abs/2602.21592)
...
### [90] [Survey on Neural Routing Solvers](https://arxiv.org/abs/2602.21761)
...
### [91] [Non-Extreme Individual Minima for Improved Pareto Front Sampling Efficiency and Decision-Making](https://arxiv.org/abs/2602.21883)
...
### [92] [Comparison of Linear Systems Across Time Domains: Continuous-time vs. Discrete-time](https://arxiv.org/abs/2602.21924)
...
### [93] [Target controllability for a minimum time problem in a trait-structured chemostat model](https://arxiv.org/abs/2602.21999)
...
### [94] [Stochastic Optimal Control with Side Information and Bayesian Learning](https://arxiv.org/abs/2602.22047)
...
### [95] [A Polyhedral Study on Unit Commitment with a Single Type of Binary Variables](https://arxiv.org/abs/2602.22058)
...
### [96] [Applying a Random-Key Optimizer on Mixed Integer Programs](https://arxiv.org/abs/2602.22173)
