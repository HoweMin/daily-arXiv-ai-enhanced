...
### [14] [Bench-MFG: A Benchmark Suite for Learning in Stationary Mean Field Games](https://arxiv.org/abs/2602.12517)
...
### [15] [AstRL: Analog and Mixed-Signal Circuit Synthesis with Deep Reinforcement Learning](https://arxiv.org/abs/2602.12402)
...
### [16] [Soft Contamination Means Benchmarks Test Shallow Generalization](https://arxiv.org/abs/2602.12413)
...
### [17] [Stabilizing Native Low-Rank LLM Pretraining](https://arxiv.org/abs/2602.12429)
...
### [18] [Safe Reinforcement Learning via Recovery-based Shielding with Gaussian Process Dynamics Models](https://arxiv.org/abs/2602.12444)
...
### [19] [Computationally sufficient statistics for Ising models](https://arxiv.org/abs/2602.12449)
...
### [20] [Regularized Meta-Learning for Improved Generalization](https://arxiv.org/abs/2602.12469)
...
### [21] [Designing RNAs with Language Models](https://arxiv.org/abs/2602.12470)
...
### [22] [Tight Bounds for Logistic Regression with Large Stepsize Gradient Descent in Low Dimension](https://arxiv.org/abs/2602.12471)
...
### [23] [Geometric separation and constructive universal approximation with two hidden layers](https://arxiv.org/abs/2602.12482)
*Chanyoung Sung*
...
### [27] [Analytical Results for Two Exponential Family Distributions in Hierarchical Dirichlet Processes](https://arxiv.org/abs/2602.12527)
*Naiqi Li*
...
### [28] [Flow-Factory: A Unified Framework for Reinforcement Learning in Flow-Matching Models](https://arxiv.org/abs/2602.12529)
...
### [29] [Exploring Accurate and Transparent Domain Adaptation in Predictive Healthcare via Concept-Grounded Orthogonal Inference](https://arxiv.org/abs/2602.12542)
...
### [31] [SD-MoE: Spectral Decomposition for Effective Expert Specialization](https://arxiv.org/abs/2602.12556)
...
### [32] [VI-CuRL: Stabilizing Verifier-Independent RL Reasoning via Confidence-Guided Variance Reduction](https://arxiv.org/abs/2602.12579)
...
### [37] [Multi-Head Attention as a Source of Catastrophic Forgetting in MoE Transformers](https://arxiv.org/abs/2602.12587)
...
### [38] [SLA2: Sparse-Linear Attention with Learnable Routing and QAT](https://arxiv.org/abs/2602.12675)
...
### [39] [Vehicle behaviour estimation for abnormal event detection using distributed fiber optic sensing](https://arxiv.org/abs/2602.12591)
...
### [40] [Trust the uncertain teacher: distilling dark knowledge via calibrated uncertainty](https://arxiv.org/abs/2602.12687)
...
### [42] [GRAIL: Geometry-Aware Retrieval-Augmented Inference with LLMs over Hyperbolic Representations of Patient Trajectories](https://arxiv.org/abs/2602.12828)
...
### [43] [Block-Sample MAC-Bayes Generalization Bounds](https://arxiv.org/abs/2602.12605)
...
### [45] [RelBench v2: A Large-Scale Benchmark and Repository for Relational Data](https://arxiv.org/abs/2602.12606)
...
### [46] [TRACE: Temporal Reasoning via Agentic Context Evolution for Streaming Electronic Health Records (EHRs)](https://arxiv.org/abs/2602.12833)
*Zhan Qu,Michael Färber*
...
### [47] [Coden: Efficient Temporal Graph Neural Networks for Continuous Prediction](https://arxiv.org/abs/2602.12613)
...
### [48] [Amortized Reasoning Tree Search: Decoupling Proposal and Decision in Large Language Models](https://arxiv.org/abs/2602.12846)
...
### [50] [X-VORTEX: Spatio-Temporal Contrastive Learning for Wake Vortex Trajectory Forecasting](https://arxiv.org/abs/2602.12869)
*Zhan Qu,Michael Färber*
...
### [51] [Formalizing the Sampling Design Space of Diffusion-Based Generative Models via Adaptive Solvers and Wasserstein-Bounded Timesteps](https://arxiv.org/abs/2602.12624)
...
### [52] [Transporting Task Vectors across Different Architectures without Training](https://arxiv.org/abs/2602.12952)
...
### [53] [Dual-Granularity Contrastive Reward via Generated Episodic Guidance for Efficient Embodied RL](https://arxiv.org/abs/2602.12636)
...
### [54] [Extending confidence calibration to generalised measures of variation](https://arxiv.org/abs/2602.12975)
...
### [55] [Drift-Aware Variational Autoencoder-based Anomaly Detection with Two-level Ensembling](https://arxiv.org/abs/2602.12976)
...
### [56] [Uncovering spatial tissue domains and cell types in spatial omics through cross-scale profiling of cellular and genomic interactions](https://arxiv.org/abs/2602.12651)
...
### [57] [Prior-Guided Symbolic Regression: Towards Scientific Consistency in Equation Discovery](https://arxiv.org/abs/2602.13021)
...
### [58] [Look Inward to Explore Outward: Learning Temperature Policy from LLM Internal States via Hierarchical RL](https://arxiv.org/abs/2602.13035)
...
### [59] [Flow Matching from Viewpoint of Proximal Operators](https://arxiv.org/abs/2602.12683)
...
### [63] [Bus-Conditioned Zero-Shot Trajectory Generation via Task Arithmetic](https://arxiv.org/abs/2602.13071)
...
### [64] [SWING: Unlocking Implicit Graph Representations for Graph Random Features](https://arxiv.org/abs/2602.12703)
...
### [65] [EXCODER: EXplainable Classification Of DiscretE time series Representations](https://arxiv.org/abs/2602.13087)
...
### [66] [QTabGAN: A Hybrid Quantum-Classical GAN for Tabular Data Synthesis](https://arxiv.org/abs/2602.12704)
...
### [67] [Which Algorithms Can Graph Neural Networks Learn?](https://arxiv.org/abs/2602.13106)
...
### [68] [Physics-Informed Laplace Neural Operator for Solving Partial Differential Equations](https://arxiv.org/abs/2602.12706)
...
### [69] [Mixture of Predefined Experts: Maximizing Data Usage on Vertical Federated Learning](https://arxiv.org/abs/2602.12708)
...
### [70] [ADEPT: RL-Aligned Agentic Decoding of Emotion via Evidence Probing Tools -- From Consensus Learning to Ambiguity-Driven Emotion Reasoning](https://arxiv.org/abs/2602.12714)
...
### [71] [Adaptive Structured Pruning of Convolutional Neural Networks for Time Series Classification](https://arxiv.org/abs/2602.12744)
...
### [72] [Hierarchical Successor Representation for Robust Transfer](https://arxiv.org/abs/2602.12753)
...
### [73] [Closing the Loop: A Control-Theoretic Framework for Provably Stable Time Series Forecasting with LLMs](https://arxiv.org/abs/2602.12756)
...
### [94] [GT-HarmBench: Benchmarking AI Safety Risks Through the Lens of Game Theory](https://arxiv.org/abs/2602.12316)
...
### [95] [A Theoretical Framework for Adaptive Utility-Weighted Benchmarking](https://arxiv.org/abs/2602.12356)
*Philip Waggoner*
...
### [97] [Scaling Web Agent Training through Automatic Data Generation and Fine-grained Evaluation](https://arxiv.org/abs/2602.12544)
...
### [104] [SkillsBench: Benchmarking How Well Agent Skills Work Across Diverse Tasks](https://arxiv.org/abs/2602.12670)
...
### [105] [X-SYS: A Reference Architecture for Interactive Explanation Systems](https://arxiv.org/abs/2602.12748)
...
### [106] [WebClipper: Efficient Evolution of Web Agents with Graph-based Trajectory Pruning](https://arxiv.org/abs/2602.12852)
...
### [107] [BrowseComp-$V^3$: A Visual, Vertical, and Verifiable Benchmark for Multimodal Browsing Agents](https://arxiv.org/abs/2602.12876)
...
### [108] [Information-theoretic analysis of world models in optimal reward maximizers](https://arxiv.org/abs/2602.12963)
...
### [109] [Consistency of Large Reasoning Models Under Multi-Turn Attacks](https://arxiv.org/abs/2602.13093)
...
### [110] [Constrained Assumption-Based Argumentation Frameworks](https://arxiv.org/abs/2602.13135)
...
### [111] [Optimal Take-off under Fuzzy Clearances](https://arxiv.org/abs/2602.13166)
...
### [112] [Real-Time Dynamic N-1 Screening: Identifying High-Risk Lines and Transformers After Common Faults](https://arxiv.org/abs/2602.12293)
...
### [113] [Existence Results and KKT Optimality Conditions for Generalized Quasiconvex Functions](https://arxiv.org/abs/2602.12455)
*M. H. Alizadeh,F. Lara*
...
### [114] [An LP-Based Approach for Bilinear Saddle Point Problem with Instance-dependent Guarantee and Noisy Feedback](https://arxiv.org/abs/2602.12513)
...
### [115] [Optimal bounds for the cost of fast controls of a KdV system](https://arxiv.org/abs/2602.12698)
*Hoai-Minh Nguyen*
...
### [116] [Constrained Mean Field Games with Grushin type dynamics](https://arxiv.org/abs/2602.12807)
...
### [117] [Explicit data-dependent characterizations of the subdifferential of convex pointwise suprema and optimality conditions](https://arxiv.org/abs/2602.12821)
...
### [118] [Parametric Biobjective Linear Programming](https://arxiv.org/abs/2602.12867)
...
### [119] [Well-posedness and mean-field limit estimate of a consensus-based algorithm for min-max problems](https://arxiv.org/abs/2602.12886)
...
### [120] [A Stochastic Optimal Control Formulation for Mine Counter Measure Simulations with Multiple Autonomous Survey Vehicles](https://arxiv.org/abs/2602.12935)
...
### [121] [A linesearch-type normal map-based semismooth Newton method for nonsmooth nonconvex composite optimization](https://arxiv.org/abs/2602.13000)
...
### [122] [Optimizing Initial Feature-Mapping Variables from Given Designs via Tracking](https://arxiv.org/abs/2602.13005)
*Patrick Jung*
...
### [123] [Multi-type random game dynamics: limits at discontinuities and cyclic limits](https://arxiv.org/abs/2602.13032)
...
### [124] [Reinterpreting EMML as Mirror Descent for Constrained Maximum Likelihood Estimation](https://arxiv.org/abs/2602.13063)
...
### [125] [New gradient methods with 3 dimensional quadratic termination](https://arxiv.org/abs/2602.13141)
...
### [126] [A Data-Driven Algorithm for Model-Free Control Synthesis](https://arxiv.org/abs/2602.13157)
...
### [127] [Operator Learning for Families of Finite-State Mean-Field Games](https://arxiv.org/abs/2602.13169)
...
### [128] [Improved Regret Guarantees for Online Mirror Descent using a Portfolio of Mirror Maps](https://arxiv.org/abs/2602.13177)
