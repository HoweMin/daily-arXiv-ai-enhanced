...
### [19] [Performative Policy Gradient: Optimality in Performative Reinforcement Learning](https://arxiv.org/abs/2512.20576)
...
### [20] [The Deleuzian Representation Hypothesis](https://arxiv.org/abs/2512.19734)
...
### [21] [Relu and softplus neural nets as zero-sum turn-based games](https://arxiv.org/abs/2512.20582)
...
### [22] [Case Prompting to Mitigate Large Language Model Bias for ICU Mortality Prediction](https://arxiv.org/abs/2512.19735)
...
### [23] [CoPHo: Classifier-guided Conditional Topology Generation with Persistent Homology](https://arxiv.org/abs/2512.19736)
...
### [24] [Simulation-Driven Railway Delay Prediction: An Imitation Learning Approach](https://arxiv.org/abs/2512.19737)
...
### [25] [OpComm: A Reinforcement Learning Framework for Adaptive Buffer Control in Warehouse Volume Forecasting](https://arxiv.org/abs/2512.19738)
...
### [26] [OASI: Objective-Aware Surrogate Initialization for Multi-Objective Bayesian Optimization in TinyML Keyword Spotting](https://arxiv.org/abs/2512.19739)
...
### [30] [From Theory to Throughput: CUDA-Optimized APML for Large-Batch 3D Learning](https://arxiv.org/abs/2512.19743)
...
### [31] [Learning to Design City-scale Transit Routes](https://arxiv.org/abs/2512.19767)
...
### [32] [A K-Means, Ward and DBSCAN repeatability study](https://arxiv.org/abs/2512.19772)
...
### [33] [Reduced Order Modeling for Tsunami Forecasting with Bayesian Hierarchical Pooling](https://arxiv.org/abs/2512.19804)
...
### [34] [Guardrailed Uplift Targeting: A Causal Optimization Playbook for Marketing Strategy](https://arxiv.org/abs/2512.19805)
*Deepit Sapru*
...
### [35] [Fine-Tuned In-Context Learners for Efficient Adaptation](https://arxiv.org/abs/2512.19879)
...
### [36] [Demystifying LLM-as-a-Judge: Analytically Tractable Model for Inference-Time Scaling](https://arxiv.org/abs/2512.19905)
...
### [37] [Modeling Non-Ergodic Path Effects Using Conditional Generative Model for Fourier Amplitude Spectra](https://arxiv.org/abs/2512.19909)
...
### [38] [Mitigating LLM Hallucination via Behaviorally Calibrated Reinforcement Learning](https://arxiv.org/abs/2512.19920)
...
### [39] [The Seismic Wavefield Common Task Framework](https://arxiv.org/abs/2512.19927)
...
### [40] [Conditional Adversarial Fragility in Financial Machine Learning under Macroeconomic Stress](https://arxiv.org/abs/2512.19935)
*Samruddhi Baviskar*
...
### [41] [Spatio-Temporal Graph Neural Networks for Dairy Farm Sustainability Forecasting and Counterfactual Policy Analysis](https://arxiv.org/abs/2512.19970)
...
### [42] [LoFT-LLM: Low-Frequency Time-Series Forecasting with Large Language Models](https://arxiv.org/abs/2512.20002)
...
### [43] [Control Variate Score Matching for Diffusion Models](https://arxiv.org/abs/2512.20003)
...
### [44] [Orthogonal Activation with Implicit Group-Aware Bias Learning for Class Imbalance](https://arxiv.org/abs/2512.20006)
...
### [45] [An Optimal Policy for Learning Controllable Dynamics by Exploration](https://arxiv.org/abs/2512.20053)
*Peter N. Loxley*
...
### [46] [PairFlow: Closed-Form Source-Target Coupling for Few-Step Generation in Discrete Flow Models](https://arxiv.org/abs/2512.20063)
...
### [47] [QE-Catalytic: A Graph-Language Multimodal Base Model for Relaxed-Energy Prediction in Catalytic Adsorption](https://arxiv.org/abs/2512.20084)
...
### [48] [Spatio-Temporal Graphs Beyond Grids: Benchmark for Maritime Anomaly Detection](https://arxiv.org/abs/2512.20086)
...
### [49] [Information-directed sampling for bandits: a primer](https://arxiv.org/abs/2512.20096)
...
### [50] [Sample-Efficient Policy Constraint Offline Deep Reinforcement Learning based on Sample Filtering](https://arxiv.org/abs/2512.20115)
...
### [51] [Learning to Reason in LLMs by Expectation Maximization](https://arxiv.org/abs/2512.20169)
...
### [52] [NeuralCrop: Combining physics and machine learning for improved crop yield predictions](https://arxiv.org/abs/2512.20177)
...
### [56] [Generalisation in Multitask Fitted Q-Iteration and Offline Q-learning](https://arxiv.org/abs/2512.20220)
...
### [58] [Adaptive Multi-task Learning for Probabilistic Load Forecasting](https://arxiv.org/abs/2512.20232)
...
### [63] [DeepONet-accelerated Bayesian inversion for moving boundary problems](https://arxiv.org/abs/2512.20268)
...
### [67] [Inverse Autoregressive Flows for Zero Degree Calorimeter fast simulation](https://arxiv.org/abs/2512.20346)
...
### [68] [Physics-guided Neural Network-based Shaft Power Prediction for Vessels](https://arxiv.org/abs/2512.20348)
...
### [69] [Field-Space Attention for Structure-Preserving Earth System Transformers](https://arxiv.org/abs/2512.20350)
...
### [70] [GeoTransolver: Learning Physics on Irregumar Domains Using Multi-scale Geometry Aware Physics Attention Transformer](https://arxiv.org/abs/2512.20399)
...
### [73] [Recurrent Off-Policy Deep Reinforcement Learning Doesn't Have to be Slow](https://arxiv.org/abs/2512.20513)
...
### [74] [Explainable time-series forecasting with sampling-free SHAP for Transformers](https://arxiv.org/abs/2512.20514)
...
### [75] [Improving ML Training Data with Gold-Standard Quality Metrics](https://arxiv.org/abs/2512.20577)
...
### [95] [MemR$^3$: Memory Retrieval via Reflective Reasoning for LLM Agents](https://arxiv.org/abs/2512.20237)
...
### [96] [ActionFlow: A Pipelined Action Acceleration for Vision Language Models on Edge](https://arxiv.org/abs/2512.20276)
...
### [97] [Synthesizing Procedural Memory: Challenges and Architectures in Automated Workflow Generation](https://arxiv.org/abs/2512.20278)
...
### [99] [Bohrium + SciMaster: Building the Infrastructure and Ecosystem for Agentic Science at Scale](https://arxiv.org/abs/2512.20469)
...
### [100] [Benchmarking LLMs for Predictive Applications in the Intensive Care Units](https://arxiv.org/abs/2512.20520)
...
### [101] [Advancing Multimodal Teacher Sentiment Analysis:The Large-Scale T-MED Dataset & The Effective AAM-TSA Model](https://arxiv.org/abs/2512.20548)
...
### [102] [Automated stereotactic radiosurgery planning using a human-in-the-loop reasoning large language model agent](https://arxiv.org/abs/2512.20586)
...
### [104] [On Convexity of Optimal Multi-Commodity Freeway Network Control](https://arxiv.org/abs/2512.19827)
...
### [105] [Efficient Gradient-Based Optimization for Joint Layout Design and Control of Wind Turbines](https://arxiv.org/abs/2512.19994)
...
### [106] [A Variational Characterization and A Line Search Newton-Noda Method for the unifying spectral problem of nonnegative tensors](https://arxiv.org/abs/2512.20031)
...
### [107] [Optimality-Informed Neural Networks for Solving Parametric Optimization Problems](https://arxiv.org/abs/2512.20270)
...
### [108] [Contingency Model-based Control (CMC) for Communicationless Cooperative Collision Avoidance in Robot Swarms](https://arxiv.org/abs/2512.20391)
*Georg Schildbach*
...
### [109] [Shadow splitting methods for nonconvex optimisation: epi-approximation, convergence and saddle point avoidance](https://arxiv.org/abs/2512.20433)
*Felipe Atenas*
...
### [110] [Exact boundary controllability and stabilizability of a degenerated Timoshenko beam](https://arxiv.org/abs/2512.20446)
...
### [111] [Neural Scaling Laws for Learning-based Identification of Nonlinear Systems](https://arxiv.org/abs/2512.20447)
...
### [112] [Asymmetric exact controllability for networks of spatial elastic strings, springs and masses](https://arxiv.org/abs/2512.20462)
...
### [113] [Adaptive Accelerated Gradient Method for Smooth Convex Optimization](https://arxiv.org/abs/2512.20478)
...
### [114] [Optimality Conditions for Control Systems Governed by Monotone Stochastic Evolution Equations](https://arxiv.org/abs/2512.20505)
...
### [115] [Random Gradient-Free Optimization in Infinite Dimensional Spaces](https://arxiv.org/abs/2512.20566)
...
### [116] [A Proximal Method for Composite Optimization with Smooth and Convex Components](https://arxiv.org/abs/2512.20602)
