...
### [16] [Ordering-based Causal Discovery via Generalized Score Matching](https://arxiv.org/abs/2601.16249)
...
### [17] [Student Mental Health Screening via Fitbit Data Collected During the COVID-19 Pandemic](https://arxiv.org/abs/2601.16324)
...
### [18] [Efficient Gaussian process learning via subspace projections](https://arxiv.org/abs/2601.16332)
...
### [19] [Analyzing Neural Network Information Flow Using Differential Geometry](https://arxiv.org/abs/2601.16366)
...
### [20] [A Regularized Actor-Critic Algorithm for Bi-Level Reinforcement Learning](https://arxiv.org/abs/2601.16399)
...
### [21] [Towards a Theoretical Understanding to the Generalization of RLHF](https://arxiv.org/abs/2601.16403)
...
### [22] [Reasoning-Enhanced Rare-Event Prediction with Balanced Outcome Correction](https://arxiv.org/abs/2601.16406)
...
### [23] [A Refinement of Vapnik--Chervonenkis' Theorem](https://arxiv.org/abs/2601.16411)
...
### [24] [Finite-Time Analysis of Gradient Descent for Shallow Transformers](https://arxiv.org/abs/2601.16514)
...
### [25] [PyHealth 2.0: A Comprehensive Open-Source Toolkit for Accessible and Reproducible Clinical Deep Learning](https://arxiv.org/abs/2601.16414)
...
### [26] [Sample-wise Constrained Learning via a Sequential Penalty Approach with Applications in Image Processing](https://arxiv.org/abs/2601.16812)
...
### [28] [FedSGM: A Unified Framework for Constraint Aware, Bidirectionally Compressed, Multi-Step Federated Optimization](https://arxiv.org/abs/2601.16897)
...
### [29] [Safe Multitask Molecular Graph Networks for Vapor Pressure and Odor Threshold Prediction](https://arxiv.org/abs/2601.16426)
...
### [30] [Endless Terminals: Scaling RL Environments for Terminal Agents](https://arxiv.org/abs/2601.16443)
...
### [31] [Brownian ReLU(Br-ReLU): A New Activation Function for a Long-Short Term Memory (LSTM) Network](https://arxiv.org/abs/2601.16446)
...
### [36] [Interpretable Fine-Gray Deep Survival Model for Competing Risks: Predicting Post-Discharge Foot Complications for Diabetic Patients in Ontario](https://arxiv.org/abs/2511.12409)
...
### [43] [Integrating Meteorological and Operational Data: A Novel Approach to Understanding Railway Delays in Finland](https://arxiv.org/abs/2601.16592)
...
### [44] [Predicting Startup Success Using Large Language Models: A Novel In-Context Learning Approach](https://arxiv.org/abs/2601.16568)
...
### [45] [E2Former-V2: On-the-Fly Equivariant Attention with Linear Activation Memory](https://arxiv.org/abs/2601.16622)
...
### [49] [Uncertainty propagation through trained multi-layer perceptrons: Exact analytical results](https://arxiv.org/abs/2601.16830)
...
### [50] [GRIP: Algorithm-Agnostic Machine Unlearning for Mixture-of-Experts via Geometric Router Constraints](https://arxiv.org/abs/2601.16905)
...
### [51] [A Scalable Measure of Loss Landscape Curvature for Analyzing the Training Dynamics of LLMs](https://arxiv.org/abs/2601.16979)
...
### [52] [Calibrated Probabilistic Interpolation for GEDI Biomass](https://arxiv.org/abs/2601.16834)
...
### [53] [The Art of Being Difficult: Combining Human and AI Strengths to Find Adversarial Instances for Heuristics](https://arxiv.org/abs/2601.16849)
...
### [54] [Provably Learning Attention with Queries](https://arxiv.org/abs/2601.16873)
...
### [55] [Theory of Minimal Weight Perturbations in Deep Networks and its Applications for Low-Rank Activated Backdoor Attacks](https://arxiv.org/abs/2601.16880)
...
### [56] [Multigrade Neural Network Approximation](https://arxiv.org/abs/2601.16884)
...
### [57] [Embedding -based Crop Type Classification in the Groundnut Basin of Senegal](https://arxiv.org/abs/2601.16900)
...
### [58] [The Trajectory Alignment Coefficient in Two Acts: From Reward Tuning to Reward Learning](https://arxiv.org/abs/2601.16906)
...
### [59] [Calibrated Similarity for Reliable Geometric Analysis of Embedding Spaces](https://arxiv.org/abs/2601.16907)
*Nicolas Tacheny*
...
### [60] [Group-realizable multi-group learning by minimizing empirical risk](https://arxiv.org/abs/2601.16922)
...
### [61] [Is BatchEnsemble a Single Model? On Calibration and Diversity of Efficient Ensembles](https://arxiv.org/abs/2601.16936)
...
### [62] [3D Molecule Generation from Rigid Motifs via SE(3) Flows](https://arxiv.org/abs/2601.16955)
...
### [63] [Auto-Regressive Masked Diffusion Models](https://arxiv.org/abs/2601.16971)
...
### [64] [Latent Diffusion for Internet of Things Attack Data Generation in Intrusion Detection](https://arxiv.org/abs/2601.16976)
...
### [65] [A Constructive Cayley Representation of Orthogonal Matrices and Applications to Optimization](https://arxiv.org/abs/2601.16271)
*Iwo Biborski*
...
### [66] [Maximizing Reach-Avoid Probabilities for Linear Stochastic Systems via Control Architectures](https://arxiv.org/abs/2601.16290)
...
### [67] [Solving Regularized Multifacility Location Problems with Unknown Number of Centers via Difference-of-Convex Optimization](https://arxiv.org/abs/2601.16576)
...
### [68] [Necessary Optimality Conditions for Integrated Learning and Optimization Problem in Contextual Optimization](https://arxiv.org/abs/2601.16581)
*Yuan Tao,Huifu Xu*
...
### [69] [Stabilization of a Wave-Heat Cascade System](https://arxiv.org/abs/2601.16610)
...
### [70] [Projected Gradient Methods with Momentum](https://arxiv.org/abs/2601.16683)
...
### [71] [Resource Allocation Based on Past Incident Patterns](https://arxiv.org/abs/2601.16702)
*M. N. M. van Lieshout*
...
### [72] [Optimal Control of Hydro-Electric Power Plants with Uncontrolled Spillways](https://arxiv.org/abs/2601.16748)
...
### [73] [Approximate controllability on the group of volume-preserving diffeomorphisms](https://arxiv.org/abs/2601.16939)
...
### [74] [BONO-Bench: A Comprehensive Test Suite for Bi-objective Numerical Optimization with Traceable Pareto Sets](https://arxiv.org/abs/2601.16970)
